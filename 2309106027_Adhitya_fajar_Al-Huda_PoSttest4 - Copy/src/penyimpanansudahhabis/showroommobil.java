...
public class showroommobil {
    ...
    public void lihatMobil(String model) {
        boolean found = false;
        for (Mobil mobil : listMobil) {
            if (mobil.getModel().equalsIgnoreCase(model)) {
                mobil.printdetailmobil();
                found = true;
            }
        }
        if (!found) {
            System.out.println("Tidak ada mobil dengan model: " + model);
        }
    }

    public void lihatMobilByMerk(String merk) {
        boolean found = false;
        for (Mobil mobil : listMobil) {
        ...
        if (!found) {
            System.out.println("Tidak ada mobil dengan merk: " + merk);
        }
    }
